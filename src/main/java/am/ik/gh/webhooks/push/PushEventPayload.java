...
@javax.annotation.Generated(value = "am.ik.gh.webhooks.PayloadGenerator", date = "2015-12-09T11:00:58.973")
@lombok.Data
public class PushEventPayload {
    ...
    public static class HeadCommit {
        ...
        private String url;
        @com.fasterxml.jackson.annotation.JsonProperty("author")
        private HeadCommitAuthor author;
        @com.fasterxml.jackson.annotation.JsonProperty("committer")
        private HeadCommitCommitter committer;
        @com.fasterxml.jackson.annotation.JsonProperty("added")
        private java.util.List<String> added;
        @com.fasterxml.jackson.annotation.JsonProperty("removed")
        private java.util.List<String> removed;
    ...
    @lombok.Data
    public static class HeadCommitAuthor {
        @com.fasterxml.jackson.annotation.JsonProperty("name")
        private String name;
        @com.fasterxml.jackson.annotation.JsonProperty("email")
        private String email;
    ...
    @lombok.Data
    public static class HeadCommitCommitter {
        @com.fasterxml.jackson.annotation.JsonProperty("name")
        private String name;
        @com.fasterxml.jackson.annotation.JsonProperty("email")
        private String email;
