...
public class GollumWebhook {
    ...
    @org.springframework.web.bind.annotation.RequestMapping(headers = "X-Github-Event=gollum")
    public String hook(@org.springframework.web.bind.annotation.RequestParam("payload") String payload,
        ...
        GollumEventPayload eventPayload = objectMapper.readValue(payload, GollumEventPayload.class);
