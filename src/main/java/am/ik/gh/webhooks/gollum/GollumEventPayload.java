...
@javax.annotation.Generated(value = "am.ik.gh.webhooks.PayloadGenerator", date = "2015-12-09T03:30:21.994")
@lombok.Data
public class GollumEventPayload {
    @com.fasterxml.jackson.annotation.JsonProperty("pages")
    @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    private java.util.List<GollumEventPayloadPage> pages;
    @com.fasterxml.jackson.annotation.JsonProperty("repository")
    @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    private GollumEventPayloadRepository repository;
    @com.fasterxml.jackson.annotation.JsonProperty("sender")
    @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    private GollumEventPayloadSender sender;

    @lombok.Data
    public static class GollumEventPayloadPage {
        @com.fasterxml.jackson.annotation.JsonProperty("page_name")
        @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    ...
    @lombok.Data
    public static class GollumEventPayloadRepository {
        ...
        @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
        private GollumEventPayloadRepositoryOwner owner;
    ...
    @lombok.Data
    public static class GollumEventPayloadRepositoryOwner {
    ...
    @lombok.Data
    public static class GollumEventPayloadSender {
        @com.fasterxml.jackson.annotation.JsonProperty("login")
        @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
        private String login;
        @com.fasterxml.jackson.annotation.JsonProperty("id")
