...
@javax.annotation.Generated(value = "am.ik.gh.webhooks.PayloadGenerator", date = "2015-12-09T11:00:58.833")
@lombok.Data
public class DeploymentStatusEventPayload {
    ...
    public static class Deployment {
        ...
        private DeploymentCreator creator;
    ...
    @lombok.Data
    public static class DeploymentCreator {
    ...
    public static class DeploymentStatus {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("creator")
        private DeploymentStatusCreator creator;
        @com.fasterxml.jackson.annotation.JsonProperty("description")
        private String description;
    ...
    @lombok.Data
    public static class DeploymentStatusCreator {
        @com.fasterxml.jackson.annotation.JsonProperty("login")
        private String login;
        @com.fasterxml.jackson.annotation.JsonProperty("id")
        private Long id;
