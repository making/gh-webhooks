...
@javax.annotation.Generated(value = "am.ik.gh.webhooks.PayloadGenerator", date = "2015-12-09T11:00:58.905")
@lombok.Data
public class PageBuildEventPayload {
    ...
    @lombok.Data
    public static class BuildPusher {
